...
#define NEO_MATRIX_TOP         0x01 // Pixel 0 is at top of matrix
#define NEO_MATRIX_BOTTOM      0x00 // Pixel 0 is at bottom of matrix
...
#define NEO_MATRIX_ROWS        0x04 // Matrix is row major (horizontal)
#define NEO_MATRIX_COLUMNS     0x00 // Matrix is column major (vertical)
...
#define NEO_TILE_TOP           0x10 // First tile is at top of matrix
#define NEO_TILE_BOTTOM        0x00 // First tile is at bottom of matrix
...
#define NEO_TILE_ROWS          0x40 // Tiles ordered in rows
#define NEO_TILE_COLUMNS       0x00 // Tiles ordered in columns
